...
#if canImport(jsonschemavalidatorFFI)
import jsonschemavalidatorFFI
#endif
...
fileprivate extension RustBuffer {
    ...
    static func from(_ ptr: UnsafeBufferPointer<UInt8>) -> RustBuffer {
        try! rustCall { ffi_jsonschemavalidator_rustbuffer_from_bytes(ForeignBytes(bufferPointer: ptr), $0) }
    }

    // Frees the buffer in place.
    // The buffer must not be used after this is called.
    func deallocate() {
        try! rustCall { ffi_jsonschemavalidator_rustbuffer_free(self, $0) }
    }
}
...
private func makeRustCall<T, E: Swift.Error>(
    ...
    uniffiEnsureJsonschemavalidatorInitialized()
...
public protocol ValidatorProtocol: AnyObject, Sendable {
     ...
     */
    func isValid(instance: String) throws  -> Bool
...
public enum ValidatorError: Swift.Error {
    ...
    /**
     * The supplied instance cannot be deserialized.
     */
...
@_documentation(visibility: private)
#endif
public func FfiConverterTypeValidatorError_lift(_ buf: RustBuffer) throws -> ValidatorError {
    return try FfiConverterTypeValidatorError.lift(buf)
}

#if swift(>=5.8)
@_documentation(visibility: private)
#endif
public func FfiConverterTypeValidatorError_lower(_ value: ValidatorError) -> RustBuffer {
...
public func uniffiEnsureJsonschemavalidatorInitialized() {
